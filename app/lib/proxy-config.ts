...
export function isFlixerCdnUrl(url: string): boolean {
  return url.includes('flixer') || url.includes('plsdontscrapemelove') || url.includes('hexa.su') || url.includes('themoviedb.hexa') || url.includes('p.10020.workers.dev') || url.includes('afc7d47f');
}
